...
public class German extends Language {
    ...
    public static final LocaleString ERROR_INGAME = new LocaleString(ERROR, "Du kannst kein Spiel beitreten während du spielst. Benutze &e/bp leave&7, um dein gegenwärtiges Match zu verlassen");
