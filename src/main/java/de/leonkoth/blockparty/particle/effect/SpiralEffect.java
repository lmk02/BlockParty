...
public class SpiralEffect extends ParticleEffect {
     ...
     */
    public SpiralEffect(ScheduledExecutorService scheduler, Location location, ParticlePlayer particlePlayer,
                           int period, double height, double rotations, double stepSize,
                           double diameter, boolean reverse, int particleAmount) {
