...
public class BlockPartyTutorialCommand extends SubCommand {
    ...
    public boolean onCommand(CommandSender sender, String[] args) {
        ...
        if (args.length > 1 && args[1].equalsIgnoreCase("patterns")) {
            sender.sendMessage(" ");
            sender.sendMessage("§8§m     §e Pattern Tutorial §8§m     ");
            ...
            sender.sendMessage(" ");
            sender.sendMessage("§8§m     §e Setup Tutorial §8§m     ");
            sender.sendMessage("§8 • §7Use §e" + BlockPartyCreateCommand.SYNTAX + " §7to create an arena.");
            sender.sendMessage("§8 • §7Use §e" + BlockPartySetSpawnCommand.SYNTAX + " §7to set the game and lobby spawn.");
            ...
            sender.sendMessage("§8 • §7Use §e" + BlockPartyEnableCommand.SYNTAX + " §7to enable the arena so players can join.");
