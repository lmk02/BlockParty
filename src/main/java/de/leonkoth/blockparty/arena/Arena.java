...
public class Arena {
    ...
    @Setter
    @Getter
    private boolean autoRestart, autoKick, enableBoosts, enableFallingBlocks, useAutoGeneratedFloors, useSchematicFloors,
    ...
    public void setDefaults(boolean save) {
        ArenaDataManager.ArenaDataSet dataSet = new ArenaDataManager.ArenaDataSet(distanceToOutArea, timeToSearch,
                levelAmount, boostDuration, minPlayers, maxPlayers, lobbyCountdown, timeReductionPerLevel, autoRestart,
