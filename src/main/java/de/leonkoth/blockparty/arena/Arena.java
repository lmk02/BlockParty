...
public class Arena {
    ...
    @Setter
    @Getter
    private boolean enabled, enableLightnings, autoRestart, autoKick, enableBoosts, enableFallingBlocks, useAutoGeneratedFloors, useSchematicFloors,
    ...
    public Arena(String name, BlockParty blockParty) {
        ...
        this.particlePlayer = new ParticlePlayer("CLOUD"); //TODO: add to config
    ...
    public void setDefaults(boolean save) {
        ArenaDataManager.ArenaDataSet dataSet = new ArenaDataManager.ArenaDataSet(distanceToOutArea, timeToSearch,
                levelAmount, boostDuration, minPlayers, maxPlayers, lobbyCountdown, timeReductionPerLevel, enabled, enableLightnings, autoRestart,
